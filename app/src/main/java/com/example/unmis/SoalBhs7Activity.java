...
public class SoalBhs7Activity extends AppCompatActivity {
    Integer nilai;
    RadioGroup rgSoalbhs7;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_soal_bhs7);
        tangkapNilai();
        kenalan();
        ketikaButtonDipencet();

        audio = MediaPlayer.create(this, R.raw.bhs7);
    ...
    private void kenalan() {
        rgSoalbhs7 = (RadioGroup)findViewById(R.id.rgSoalbhs7);
        ...
        btnNext7.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (rdbA.isChecked()) {
                    ...
                    Toast.makeText(SoalBhs7Activity.this, "Anda tidak memilih jawaban", Toast.LENGTH_SHORT).show();
                    Log.i("Salah", String.valueOf(nilai));
                }

                Intent a = new Intent(getApplicationContext(),SoalBhs8Activity.class);
