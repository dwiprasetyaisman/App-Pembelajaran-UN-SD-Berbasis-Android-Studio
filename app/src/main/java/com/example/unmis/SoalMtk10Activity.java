...
public class SoalMtk10Activity extends AppCompatActivity {
    Integer nilai;
    RadioGroup rgSoalmtk10;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_soal_mtk10);
        tangkapNilai();
        kenalan();
        ketikaButtonDipencet();

        audio = MediaPlayer.create(this, R.raw.mtk10);
    ...
    private void kenalan() {
        rgSoalmtk10 = (RadioGroup)findViewById(R.id.rgSoalmtk10);
        ...
        btnNext10.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (rdbA.isChecked()) {
                    ...
                    Toast.makeText(SoalMtk10Activity.this, "Anda tidak memilih jawaban", Toast.LENGTH_SHORT).show();
                    Log.i("Salah", String.valueOf(nilai));
                }

                Intent a = new Intent(getApplicationContext(),SoalMtk11Activity.class);
