...
public class SoalMtk9Activity extends AppCompatActivity {
    Integer nilai;
    RadioGroup rgSoalmtk9;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_soal_mtk9);
        tangkapNilai();
        kenalan();
        ketikaButtonDipencet();

        audio = MediaPlayer.create(this, R.raw.mtk9);
    ...
    private void kenalan() {
        rgSoalmtk9 = (RadioGroup)findViewById(R.id.rgSoalmtk9);
        ...
        btnNext9.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (rdbA.isChecked()) {
                    ...
                    Toast.makeText(SoalMtk9Activity.this, "Anda tidak memilih jawaban", Toast.LENGTH_SHORT).show();
                    Log.i("Salah", String.valueOf(nilai));
                }

                Intent a = new Intent(getApplicationContext(),SoalMtk10Activity.class);
