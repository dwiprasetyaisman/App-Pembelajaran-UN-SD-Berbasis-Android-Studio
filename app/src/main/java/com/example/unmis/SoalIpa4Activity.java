...
public class SoalIpa4Activity extends AppCompatActivity {
    Integer nilai;
    RadioGroup rgSoalipa4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_soal_ipa4);
        tangkapNilai();
        kenalan();
        ketikaButtonDipencet();

        audio = MediaPlayer.create(this, R.raw.ipa4);
    ...
    private void kenalan() {
        rgSoalipa4 = (RadioGroup) findViewById(R.id.rgSoalipa4);
        ...
        btnNext4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (rdbA.isChecked()) {
                    ...
                    Toast.makeText(SoalIpa4Activity.this, "Anda tidak memilih jawaban", Toast.LENGTH_SHORT).show();
                    Log.i("Salah", String.valueOf(nilai));
                }

                Intent a = new Intent(getApplicationContext(), SoalIpa5Activity.class);
