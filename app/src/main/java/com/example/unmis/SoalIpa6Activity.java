...
public class SoalIpa6Activity extends AppCompatActivity {
    Integer nilai;
    RadioGroup rgSoalipa6;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_soal_ipa6);
        tangkapNilai();
        kenalan();
        ketikaButtonDipencet();

        audio = MediaPlayer.create(this, R.raw.ipa6);
    ...
    private void kenalan() {
        rgSoalipa6 = (RadioGroup) findViewById(R.id.rgSoalipa6);
        ...
        btnNext6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (rdbA.isChecked()) {
                    ...
                    Toast.makeText(SoalIpa6Activity.this, "Anda tidak memilih jawaban", Toast.LENGTH_SHORT).show();
                    Log.i("Salah", String.valueOf(nilai));
                }

                Intent a = new Intent(getApplicationContext(), SoalIpa7Activity.class);
