...
public class SoalBhs5Activity extends AppCompatActivity {
    Integer nilai;
    RadioGroup rgSoalbhs5;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_soal_bhs5);
        tangkapNilai();
        kenalan();
        ketikaButtonDipencet();

        audio = MediaPlayer.create(this, R.raw.bhs5);
    ...
    private void kenalan() {
        rgSoalbhs5 = (RadioGroup)findViewById(R.id.rgSoalbhs5);
        ...
        btnNext5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (rdbA.isChecked()) {
                    ...
                    Toast.makeText(SoalBhs5Activity.this, "Anda tidak memilih jawaban", Toast.LENGTH_SHORT).show();
                    Log.i("Salah", String.valueOf(nilai));
                }

                Intent a = new Intent(getApplicationContext(),SoalBhs6Activity.class);
