...
public class SoalIpa12Activity extends AppCompatActivity {
    Integer nilai;
    RadioGroup rgSoalipa12;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_soal_ipa12);
        tangkapNilai();
        kenalan();
        ketikaButtonDipencet();

        audio = MediaPlayer.create(this, R.raw.ipa12);
    ...
    private void kenalan() {
        rgSoalipa12 = (RadioGroup) findViewById(R.id.rgSoalipa12);
        ...
        btnNext12.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (rdbA.isChecked()) {
                    ...
                    Toast.makeText(SoalIpa12Activity.this, "Anda tidak memilih jawaban", Toast.LENGTH_SHORT).show();
                    Log.i("Salah", String.valueOf(nilai));
                }

                Intent a = new Intent(getApplicationContext(),SoalIpa13Activity.class);
