...
public class SoalMtk8Activity extends AppCompatActivity {
    Integer nilai;
    RadioGroup rgSoalmtk8;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_soal_mtk8);
        tangkapNilai();
        kenalan();
        ketikaButtonDipencet();

        audio = MediaPlayer.create(this, R.raw.mtk8);
    ...
    private void kenalan() {
        rgSoalmtk8 = (RadioGroup)findViewById(R.id.rgSoalmtk8);
        ...
        btnNext8.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (rdbA.isChecked()) {
                    ...
                    Toast.makeText(SoalMtk8Activity.this, "Anda tidak memilih jawaban", Toast.LENGTH_SHORT).show();
                    Log.i("Salah", String.valueOf(nilai));
                }

                Intent a = new Intent(getApplicationContext(),SoalMtk9Activity.class);
