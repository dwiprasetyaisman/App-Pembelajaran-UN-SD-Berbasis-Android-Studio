...
public class SoalBhs2Activity extends AppCompatActivity {
    Integer nilai;
    RadioGroup rgSoalbhs2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_soal_bhs2);
        tangkapNilai();
        kenalan();
        ketikaButtonDipencet();

        audio = MediaPlayer.create(this, R.raw.bhs2);
    ...
    private void kenalan() {
        rgSoalbhs2 = (RadioGroup)findViewById(R.id.rgSoalbhs2);
        ...
        btnNext2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (rdbA.isChecked()) {
                    ...
                    Toast.makeText(SoalBhs2Activity.this, "Anda tidak memilih jawaban", Toast.LENGTH_SHORT).show();
                    Log.i("Salah", String.valueOf(nilai));
                }

                Intent a = new Intent(getApplicationContext(),SoalBhs3Activity.class);
