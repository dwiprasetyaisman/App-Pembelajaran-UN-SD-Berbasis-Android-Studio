...
public class SoalIpa11Activity extends AppCompatActivity {
    Integer nilai;
    RadioGroup rgSoalipa11;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_soal_ipa11);
        tangkapNilai();
        kenalan();
        ketikaButtonDipencet();

        audio = MediaPlayer.create(this, R.raw.ipa11);
    ...
    private void kenalan() {
        rgSoalipa11 = (RadioGroup) findViewById(R.id.rgSoalipa11);
        ...
        btnNext11.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (rdbA.isChecked()) {
                    ...
                    Toast.makeText(SoalIpa11Activity.this, "Anda tidak memilih jawaban", Toast.LENGTH_SHORT).show();
                    Log.i("Salah", String.valueOf(nilai));
                }

                Intent a = new Intent(getApplicationContext(),SoalIpa12Activity.class);
