...
public class SoalBhs8Activity extends AppCompatActivity {
    Integer nilai;
    RadioGroup rgSoalbhs8;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_soal_bhs8);
        tangkapNilai();
        kenalan();
        ketikaButtonDipencet();

        audio = MediaPlayer.create(this, R.raw.bhs8);
    ...
    private void kenalan() {
        rgSoalbhs8 = (RadioGroup)findViewById(R.id.rgSoalbhs8);
        ...
        btnNext8.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (rdbA.isChecked()) {
                    ...
                    Toast.makeText(SoalBhs8Activity.this, "Anda tidak memilih jawaban", Toast.LENGTH_SHORT).show();
                    Log.i("Salah", String.valueOf(nilai));
                }

                Intent a = new Intent(getApplicationContext(),SoalBhs9Activity.class);
