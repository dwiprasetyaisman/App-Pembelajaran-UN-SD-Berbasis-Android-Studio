...
public class SoalBhs3Activity extends AppCompatActivity {
    Integer nilai;
    RadioGroup rgSoalbhs3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_soal_bhs3);
        tangkapNilai();
        kenalan();
        ketikaButtonDipencet();

        audio = MediaPlayer.create(this, R.raw.bhs3);
    ...
    private void kenalan() {
        rgSoalbhs3 = (RadioGroup)findViewById(R.id.rgSoalbhs3);
        ...
        btnNext3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (rdbA.isChecked()) {
                    ...
                    Toast.makeText(SoalBhs3Activity.this, "Anda tidak memilih jawaban", Toast.LENGTH_SHORT).show();
                    Log.i("Salah", String.valueOf(nilai));
                }

                Intent a = new Intent(getApplicationContext(), SoalBhs4Activity.class);
