...
public class SoalIpa8Activity extends AppCompatActivity {
    Integer nilai;
    RadioGroup rgSoalipa8;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_soal_ipa8);
        tangkapNilai();
        kenalan();
        ketikaButtonDipencet();

        audio = MediaPlayer.create(this, R.raw.ipa8);
    ...
    private void kenalan() {
        rgSoalipa8 = (RadioGroup) findViewById(R.id.rgSoalipa8);
        ...
        btnNext8.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (rdbA.isChecked()) {
                    ...
                    Toast.makeText(SoalIpa8Activity.this, "Anda tidak memilih jawaban", Toast.LENGTH_SHORT).show();
                    Log.i("Salah", String.valueOf(nilai));
                }

                Intent a = new Intent(getApplicationContext(), SoalIpa9Activity.class);
