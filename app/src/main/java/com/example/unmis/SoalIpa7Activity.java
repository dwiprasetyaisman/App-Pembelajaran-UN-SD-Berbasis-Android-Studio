...
public class SoalIpa7Activity extends AppCompatActivity {
    Integer nilai;
    RadioGroup rgSoalipa7;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_soal_ipa7);
        tangkapNilai();
        kenalan();
        ketikaButtonDipencet();

        audio = MediaPlayer.create(this, R.raw.ipa7);
    ...
    private void kenalan() {
        rgSoalipa7 = (RadioGroup) findViewById(R.id.rgSoalipa7);
        ...
        btnNext7.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (rdbA.isChecked()) {
                    ...
                    Toast.makeText(SoalIpa7Activity.this, "Anda tidak memilih jawaban", Toast.LENGTH_SHORT).show();
                    Log.i("Salah", String.valueOf(nilai));
                }

                Intent a = new Intent(getApplicationContext(), SoalIpa8Activity.class);
