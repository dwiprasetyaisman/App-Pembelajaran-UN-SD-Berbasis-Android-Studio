...
public class SoalBhs9Activity extends AppCompatActivity {
    Integer nilai;
    RadioGroup rgSoalbhs9;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_soal_bhs9);
        tangkapNilai();
        kenalan();
        ketikaButtonDipencet();

        audio = MediaPlayer.create(this, R.raw.bhs9);
    ...
    private void kenalan() {
        rgSoalbhs9 = (RadioGroup)findViewById(R.id.rgSoalbhs9);
        ...
        btnNext9.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (rdbA.isChecked()) {
                    ...
                    Toast.makeText(SoalBhs9Activity.this, "Anda tidak memilih jawaban", Toast.LENGTH_SHORT).show();
                    Log.i("Salah", String.valueOf(nilai));
                }

                Intent a = new Intent(getApplicationContext(),SoalBhs10Activity.class);
