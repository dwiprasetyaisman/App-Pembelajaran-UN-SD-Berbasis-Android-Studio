...
public class SoalBhs4Activity extends AppCompatActivity {
    Integer nilai;
    RadioGroup rgSoalbhs4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_soal_bhs4);
        tangkapNilai();
        kenalan();
        ketikaButtonDipencet();

        audio = MediaPlayer.create(this, R.raw.bhs4);
    ...
    private void kenalan() {
        rgSoalbhs4 = (RadioGroup)findViewById(R.id.rgSoalbhs4);
        ...
        btnNext4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (rdbA.isChecked()) {
                    ...
                    Toast.makeText(SoalBhs4Activity.this, "Anda tidak memilih jawaban", Toast.LENGTH_SHORT).show();
                    Log.i("Salah", String.valueOf(nilai));
                }

                Intent a = new Intent(getApplicationContext(),SoalBhs5Activity.class);
