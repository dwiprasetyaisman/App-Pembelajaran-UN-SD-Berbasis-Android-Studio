...
public class SoalIpa9Activity extends AppCompatActivity {
    Integer nilai;
    RadioGroup rgSoalipa9;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_soal_ipa9);
        tangkapNilai();
        kenalan();
        ketikaButtonDipencet();

        audio = MediaPlayer.create(this, R.raw.ipa9);
    ...
    private void kenalan() {
        rgSoalipa9 = (RadioGroup) findViewById(R.id.rgSoalipa9);
        ...
        btnNext9 = (Button) findViewById(R.id.btnNext9);
    }
        ...
        btnNext9.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (rdbA.isChecked()) {
                    ...
                    Toast.makeText(SoalIpa9Activity.this, "Anda tidak memilih jawaban", Toast.LENGTH_SHORT).show();
                    Log.i("Salah", String.valueOf(nilai));
                }

                Intent a = new Intent(getApplicationContext(), SoalIpa10Activity.class);
